...
// +----------------------------------------------------------------------+
//
// $Id vlib.vlibDate.3.0.1 23/06/2002 $
...
if (!defined('vlibDateClassLoaded')) {
    ...
    \-----------------------------------------------------------------------------*/
        ...
        var $accepted_langs = array('en','fr','de','es','pt','nl','it','no','sv','da','fi');
    ...
    \-----------------------------------------------------------------------------*/
         ...
         *            (%E is useful for passing a date in a URL as an integer value.
    ...
    \-----------------------------------------------------------------------------*/
        ...
        function vlibDate ($lang = null) {
            ...
            $default_lang = $VLIB_PARAMS['vlibDate']['DEFAULT_LANG'];
